...
public class Tentativas {
	...
	public void getTentativas(Tentativas t) {
		...
		System.out.println(+t.maior +" das tentativas foram números maiores que o número correto.");
		System.out.println(+t.menor +" das tentativas foram números menores que o número correto.");
	}
}